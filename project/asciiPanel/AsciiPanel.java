...
public class AsciiPanel extends JPanel {
    ...
    public static Color brownness = new Color(85,107,47);
    ...
    private void loadGlyphs() {
        try {
            ...
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/leftBound.png"));
            glyphs[0].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, null);       
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/rightBound.png"));
            glyphs[1].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, null);
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/Wall.png"));
            glyphs[2].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, null);
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/Step.png"));
            glyphs[3].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, null);
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/Barrier.png"));
            glyphs[4].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, null);
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/monster.png"));
            for(int i = 5; i < 11; ++i) {
            	int sy = 18 + ((i - 5) / 2) * 64;//46 -- 48
            	int sx = ((i - 5) % 2) * 48;
            	glyphs[i].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, sx, sy, sx + 47, sy + 29, null);
            }
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/button1.png"));
            glyphs[11].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, null);
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/button2.png"));
            glyphs[12].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, null);
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/player1.png"));
        	glyphs[13].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, 0, 0, 32, 48, null);
            for(int i = 14; i < 18; ++i) {
            	int sy = ((i - 12) / 2) * 48;
            	int sx = ((i - 12) % 2) * 32;
            	glyphs[i].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, sx, sy, sx + 32, sy + 48, null);
            }
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/button1.png"));
            glyphs[18].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, null);
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource("resources/player2.png"));
            glyphs[19].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, 0, 0, 32, 48, null);
            for(int i = 20; i < 24; ++i) {
            	int sy = ((i - 12) / 2) * 48;
            	int sx = ((i - 12) % 2) * 32;
            	glyphs[i].getGraphics().drawImage(glyphSprite, 0, 0, charWidth, charHeight, sx, sy, sx + 32, sy + 48, null);
